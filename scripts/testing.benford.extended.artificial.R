...
for (i in 1:length(generative.models)) {
  ...
  for (j in 1:length(parameter.set)) {
    ...
    d.chisq.test <-  sum(as.numeric(matrix(unlist(d.chisq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    d.ks <- lapply(d, ks.benftest)
    d.ks.test <-  sum(as.numeric(matrix(unlist(d.ks), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    d.usq <- lapply(d, usq.benftest)
    d.usq.test <-  sum(as.numeric(matrix(unlist(d.usq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    d.mdist <- lapply(d, mdist.benftest)
    d.mdist.test <-  sum(as.numeric(matrix(unlist(d.mdist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    d.edist <- lapply(d, edist.benftest)
    d.edist.test <-  sum(as.numeric(matrix(unlist(d.edist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    d.meandigit <- lapply(d, meandigit.benftest)
    d.meandigit.test <-  sum(as.numeric(matrix(unlist(d.meandigit), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    d.jpsq <- lapply(d, jpsq.benftest)
    d.jpsq.test <-  sum(as.numeric(matrix(unlist(d.jpsq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    d.jointdigit <- lapply(d, jointdigit.benftest)
    d.jointdigit.test <-  sum(as.numeric(matrix(unlist(d.jointdigit), ncol = 6, byrow = TRUE)[,2]) >= 0.05)
    ...
    b.chisq.test <-  sum(as.numeric(matrix(unlist(b.chisq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    b.ks <- lapply(b, ks.benftest)
    b.ks.test <-  sum(as.numeric(matrix(unlist(b.ks), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    b.usq <- lapply(b, usq.benftest)
    b.usq.test <-  sum(as.numeric(matrix(unlist(b.usq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    b.mdist <- lapply(b, mdist.benftest)
    b.mdist.test <-  sum(as.numeric(matrix(unlist(b.mdist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    b.edist <- lapply(b, edist.benftest)
    b.edist.test <-  sum(as.numeric(matrix(unlist(b.edist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    b.meandigit <- lapply(b, meandigit.benftest)
    b.meandigit.test <-  sum(as.numeric(matrix(unlist(b.meandigit), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    b.jpsq <- lapply(b, jpsq.benftest)
    b.jpsq.test <-  sum(as.numeric(matrix(unlist(b.jpsq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    b.jointdigit <- lapply(b, jointdigit.benftest)
    b.jointdigit.test <-  sum(as.numeric(matrix(unlist(b.jointdigit), ncol = 6, byrow = TRUE)[,2]) >= 0.05)
    ...
    c.chisq.test <-  sum(as.numeric(matrix(unlist(c.chisq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    c.ks <- lapply(c, ks.benftest)
    c.ks.test <-  sum(as.numeric(matrix(unlist(c.ks), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
   
    c.usq <- lapply(c, usq.benftest)
    c.usq.test <-  sum(as.numeric(matrix(unlist(c.usq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    c.mdist <- lapply(c, mdist.benftest)
    c.mdist.test <-  sum(as.numeric(matrix(unlist(c.mdist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    c.edist <- lapply(c, edist.benftest)
    c.edist.test <-  sum(as.numeric(matrix(unlist(c.edist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    c.meandigit <- lapply(c, meandigit.benftest)
    c.meandigit.test <-  sum(as.numeric(matrix(unlist(c.meandigit), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    c.jpsq <- lapply(c, jpsq.benftest)
    c.jpsq.test <-  sum(as.numeric(matrix(unlist(c.jpsq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    c.jointdigit <- lapply(c, jointdigit.benftest)
    c.jointdigit.test <-  sum(as.numeric(matrix(unlist(c.jointdigit), ncol = 6, byrow = TRUE)[,2]) >= 0.05)
    ...
    l.chisq.test <-  sum(as.numeric(matrix(unlist(l.chisq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    l.ks <- lapply(l, ks.benftest)
    l.ks.test <-  sum(as.numeric(matrix(unlist(l.ks), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
   
    l.usq <- lapply(l, usq.benftest)
    l.usq.test <-  sum(as.numeric(matrix(unlist(l.usq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    l.mdist <- lapply(l, mdist.benftest)
    l.mdist.test <-  sum(as.numeric(matrix(unlist(l.mdist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    l.edist <- lapply(l, edist.benftest)
    l.edist.test <-  sum(as.numeric(matrix(unlist(l.edist), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    l.meandigit <- lapply(l, meandigit.benftest)
    l.meandigit.test <-  sum(as.numeric(matrix(unlist(l.meandigit), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    l.jpsq <- lapply(l, jpsq.benftest)
    l.jpsq.test <-  sum(as.numeric(matrix(unlist(l.jpsq), ncol = 4, byrow = TRUE)[,2]) >= 0.05)
    
    l.jointdigit <- lapply(l, jointdigit.benftest)
    l.jointdigit.test <-  sum(as.numeric(matrix(unlist(l.jointdigit), ncol = 6, byrow = TRUE)[,2]) >= 0.05)
...
write.csv(x = test.results, file = 'results.extended.artificial.networks.csv')
